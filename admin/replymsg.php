...
$to=$ft->validation($_POST['toEmail']);
$from=$ft->validation($_POST['fromEmail']);
$subject=$ft->validation($_POST['subject']);
$message=$ft->validation($_POST['message']);

$sendEmail=mail($to, $subject, $message,$from);
if ($sendEmail) {
    echo "<span class='success'>Send Email Successfully. </span>";
}else{
